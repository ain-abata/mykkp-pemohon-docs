    ...
    <div>
      <ol>
        <li>
          ...
          {senaraiJkkp5ImgSrc && (
            <ExpandableImage src={senaraiJkkp5ImgSrc} alt="Senarai Pemberitahuan Aktiviti Industri - JKKP5" />
          )}
        </li>
        ...
        <li>
          ...
          {butangConsAnalysisImgSrc && (
            <ExpandableImage src={butangConsAnalysisImgSrc} alt="Butang Consequences Analysis" />
          )}
        </li>
        ...
        <li>
          ...
          {tabConsAnalysisImgSrc && (
            <ExpandableImage src={tabConsAnalysisImgSrc} alt="Tab Consequences Analysis" />
          )}
        </li>
        ...
        <li>
          ...
          {popupPilihanBahanBerbahayaImgSrc && (
            <ExpandableImage src={popupPilihanBahanBerbahayaImgSrc} alt="Pop-up Pilihan Bahan Berbahaya" />
          )}
        </li>
        ...
        <li>
          ...
          {senaraiBahanBerbahayaImgSrc && (
            <ExpandableImage src={senaraiBahanBerbahayaImgSrc} alt="Jadual Senarai Bahan Berbahaya" />
          )}
        </li>
        ...
        <li>
          ...
          {gambarJadualConsequencesAnalysisImgSrc && (
            <ExpandableImage src={gambarJadualConsequencesAnalysisImgSrc} alt="Jadual Consequences Analysis" />
          )}
        </li>
        ...
        <li>
          Pop-up makluman akan terpapar seperti di bawah.
          {mesejHantarImgSrc && (
            <ExpandableImage src={mesejHantarImgSrc} alt="Mesej Hantar Consequences Analysis" />
          )}
        </li>
