...
interface TabDokumenSokonganProps {
  tabNumber: number;
  tabName: string;
  tabImgSrc?: string;
}

export default function TabDokumenSokongan({
  tabNumber,
  tabName,
  tabImgSrc,
  ...
  return (
    <div>
      ...
      <ol>
        <li>Klik butang <img src={uploadIcon} style={{ width: 15 }} /> untuk memuat naik dokumen yang berkenaan pada medan yang disediakan.</li>
