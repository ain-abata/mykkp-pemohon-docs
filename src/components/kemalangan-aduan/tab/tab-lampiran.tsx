...
interface TabLampiranProps {
  tabNumber: number;
  tabName: string;
  tabImgSrc?: string;
}

export default function TabLampiran({
  tabNumber,
  tabName,
  tabImgSrc,
}: TabLampiranProps) {
  return (
    <div>
      ...
      <ol>
        <li>Klik butang <img src={uploadIcon} style={{ width: 15 }} /> untuk memuat naik dokumen yang berkenaan pada medan.</li>
