    ...
    <details className="faq-item">
       ...
       <summary>Saya telah bertukar majikan, adakah saya perlu mendaftarkan semula OSH-Coordinator untuk majikan baharu?</summary>
         <div className="faq-answer">
           ...
           2. Pergi ke menu **Profil Saya**. 
           3. Pilih **Maklumat OYK**.  
           4. Skrol ke bawah dan klik **Kemaskini Maklumat OYK**.
           5. Pilih **Kategori -> Maklumat Majikan**.
           6. Klik **Kemaskini**.  
           7. Buat carian majikan baharu  
           8. Klik **Simpan**.
         </div>
    </details>
    <details className="faq-item">
