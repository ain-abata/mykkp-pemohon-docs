---
title: Pemberitahuan Status Loji (PSL) - Tidak Digunakan
description: Panduan lengkap pemberitahuan status loji - tidak digunakan
hide_table_of_contents: false
sidebar_label: 'Tidak Digunakan'
---
...
Kriteria pemohon yang dibenarkan untuk menghantar permohonan **Pemberitahuan Status Loji (Tidak Digunakan)** adalah seperti berikut:
1. Pemunya loji yang telah berdaftar sebagai **PATK Tahap 1** untuk **Tidak Digunakan** pada sistem MyKKP.
2. Penghuni (Tempat Loji) yang telah berdaftar sebagai **PATK Tahap 1** untuk **Tidak Digunakan** pada sistem MyKKP.

Syarat-syarat bagi status loji yang dibenarkan untuk permohonan **Pemberitahuan Status Loji (Tidak Digunakan)** adalah seperti berikut:
1. Aktif
2. Tidak digunakan
3. Tindakan Aduan


Jenis jentera yang terlibat bagi permohonan **Pemberitahuan Status Loji (Tidak Digunakan)** adalah seperti berikut:
1. PMA
...
Pemohon perlu menyediakan dokumen yang diperlukan bagi permohonan **Pemberitahuan Status Loji (Tidak Digunakan)** seperti:

| Bil. | Keterangan                                                 | Syarat      |
|------|------------------------------------------------------------|-------------|
| 1.   | Surat pemberitahuan (sila nyatakan sebab tidak digunakan). | Wajib       |
| 2.   | Gambar loji yang tidak gunakan.                            | Tidak Wajib |
